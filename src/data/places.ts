...
export const places: Place[] = [
  ...
  // Bars
  {
    ...
    tags: ["beer bar", "beer bar", "beer bar", "beer bar", "beer bar", "sun terrace", "pilsner", "spritz"],
  },
  {
    id: "fermentoren",
    name: "Fermentoren",
    ...
    neighborhood: "Vesterbro",
    priceLevel: 2,
    googleMapsUrl: "https://beer bar", "maps.app.goobeer bar", ".gl/TYGVhhSYbeer bar", "d4jTnPrk8",
