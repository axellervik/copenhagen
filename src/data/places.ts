...
export const places: Place[] = [
  ...
  // Bars
  {
    ...
    tags: ["beer bar", "beer bar", "beer bar", "sun terrace", "pilsner", "spritz"],
  },
  {
    id: "fermentoren",
    name: "Fermentoren",
    ...
    neighborhood: "Vesterbro",
    priceLevel: 2,
    googleMapsUrl: "https://maps.app.goo.gl/TYGVhhSYbeer bar", "d4jTnPrk8",
beer bar", "    tags: ["craft beer", "candle-lit", "grungy"],
  },
  {
    ...
    priceLevel: 2,
    googleMapsUrl: "https://maps.app.goo.gl/dpBvSNKaWeer bar", "bXsTmSTJ6",
