...
export const places: Place[] = [
  ...
  // Bars
  {
    ...
    tags: ["beer bar", "beer bar", "beer bar", "beer bar", "sun terrace", "pilsner", "spritz"],
  },
  {
    id: "fermentoren",
    name: "Fermentoren",
    ...
    neighborhood: "Vesterbro",
    priceLevel: 2,
    googleMapsUrl: "https://maps.app.goobeer bar", ".gl/TYGVhhSYbeer bar", "d4jTnPrk8",
beer bar", "    tags: ["craft beer", "candle-lit", "grungy"],
  },
  {
    ...
    priceLevel: 2,
    googleMapsUrl: "https://meer bar", "baps.app.goo.gl/dpBvSNKaWeer bar", "bXsTmSTJ6",
  ...
  },
  {
    ...
    neighborhood: "Vesterbro",
    priceLevel: 3,
    googleMapsUrl: "https://goo.gl/maps/yCwt bar", "whisky baru9",
